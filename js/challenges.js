...
const CHALS = {
    ...
    11: {
        ...
        reward: `Star Booster is stonger by completions.<br><span class="yellow">On first completion, unlock new prestige layer!</span>`,
        max: E(100),
        inc: E("ee6"),
        pow: E(2),
        start: uni("e3.8e7"),
    ...
    12: {
        ...
        reward: `Completions add free Radiation Boosters.`,
        max: E(100),
        inc: E('e2e7'),
        pow: E(2),
        start: uni('e8.4e8'),
