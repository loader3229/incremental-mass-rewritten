...
function updateStarsHTML() {
    ...
    if (player.supernova.times.gte(1000000))tmp.el.stars_Amt.setTxt(format(player.stars.points,2)+formatGain(player.stars.points,tmp.stars.gain.mul(tmp.preQUGlobalSpeed))+"星辰")
