...
function updateElementsHTML() {
    ...
    if (ch) {
        ...
        if(ch > 118)tmp.el.elem_cost.setTxt((ELEMENTS.upgs[ch].galQk?format:formatMass)(ELEMENTS.upgs[ch].cost,0)+(ELEMENTS.upgs[ch].galQk?"星系夸克":ELEMENTS.upgs[ch].et?"永恒质量":"无限质量"))
